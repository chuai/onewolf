...
<![endif]-->
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
					{id:"1",zhiwei:"java开发",department:"技术", company:"豪沃", addtime:"2015-2-14",endtime:"2015-2-14", hetongTime:"1000", canbu:"1000", trafficBu:"1000", otherBu:"15", remark:"项目已上线"}
			];	
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:['操作', 'ID', '职位', '部门', '公司', '开始时间', '结束时间', '合同期限','餐补','交通补', '其余福利','备注'],
					colModel:[
						...
						{name:'zhiwei',index:'zhiwei', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
						...
						{name:'hetongTime',index:'hetongTime', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{name:'canbu',index:'canbu', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'trafficBu',index:'trafficBu', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'otherBu',index:'otherBu', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
