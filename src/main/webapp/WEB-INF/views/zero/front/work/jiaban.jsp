...
<![endif]-->
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
					{id:"1",department:"技术", company:"豪沃", addtime:"2015-2-14",endtime:"2015-2-14", jiabanthings:"1000",persent:"1000", signName:"1000", jiabanMan:"1000", canbu:"15", jiabanPrice:"1000", remark:"项目上线"}
			];	
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:['操作', 'ID', '部门', '公司', '开始时间', '结束时间', '加班事由', '任务完成百分比','领导签名人', '加班同事', '加班餐补','加班费','备注'],
					colModel:[
						...
						{name:'endtime',index:'endtime',width:90, editable:true, sorttype:"date",unformat: pickDate},
						{name:'jiabanthings',index:'jiabanthings', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{name:'persent',index:'persent', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'signName',index:'signName', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'jiabanMan',index:'jiabanMan', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'canbu',index:'canbu', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'jiabanPrice',index:'jiabanPrice', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
