...
<![endif]-->
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
					{id:"1",department:"技术", company:"豪沃", addtime:"2015-2-14",endtime:"2015-2-14", tiaoxiouthings:"1000",tiaoxiouTime:"1000", shenyuTime:"1000", tikou:"1000", signName:"15", remark:"项目已上线"}
			];	
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:['操作', 'ID', '部门', '公司', '开始时间', '结束时间', '调班事由', '调休时长','剩余时长','抵扣', '领导签名人','备注'],
					colModel:[
						...
						{name:'tiaoxiouthings',index:'jiabanthings', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{name:'tiaoxiouTime',index:'persent', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'shenyuTime',index:'signName', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'tikou',index:'jiabanMan', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{name:'signName',index:'canbu', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
